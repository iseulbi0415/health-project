...
public interface RunRepository extends JpaRepository<Run, Long> {
    ...
    List<Run> findByUserIdOrderByRecordedAtDesc(Long userId);

    // 하루 필터링(GET ?date=)과 달력 월별 요약 양쪽에서 재사용
    List<Run> findByUserIdAndRecordedAtGreaterThanEqualAndRecordedAtLessThanOrderByRecordedAtDesc(Long userId, LocalDateTime start, LocalDateTime end);
