...
public interface FoodRepository extends JpaRepository<Food, Long>{
    ...
    List<Food> findByUserIdOrderByRecordedAtDesc(Long userId);

    // 하루 필터링(GET ?date=)과 달력 월별 요약 양쪽에서 재사용
    List<Food> findByUserIdAndRecordedAtGreaterThanEqualAndRecordedAtLessThanOrderByRecordedAtDesc(Long userId, LocalDateTime start, LocalDateTime end);
