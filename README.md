...
개인차가 커 정밀한 추정에는 한계가 있습니다. 위 Mifflin-St Jeor 원 논문(1990)
자체에는 활동계수가 포함되어 있지 않으며, 활동계수는 별도로 통용되는 값을
가져와 곱하는 방식입니다.
...
- 계정 삭제 시 계정 정보와 모든 기록이 즉시 삭제되며, 카카오·Apple 계정과의 연결도
  함께 해제됩니다. 자세한 내용은 [개인정보 처리방침](https://iseulbi0415.github.io/health-project/privacy.html)을
  참고해 주세요.
